...
void _test_voidApi_tc_createAuto(
    test_voidApi this)
{
...
void _test_voidApi_tc_createChild(
    test_voidApi this)
{
...
void _test_voidApi_tc_createChildAuto(
    test_voidApi this)
{
