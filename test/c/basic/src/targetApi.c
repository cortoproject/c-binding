...
/* $begin(test/targetApi/tc_compare) */
    ...
    test_intTarget a = test_intTargetCreate(10, 20);
    test_intTarget b = test_intTargetCreate(20, 30);
...
/* $begin(test/targetApi/tc_create) */
    test_intTarget o = test_intTargetCreate(10, 20);
    test_assert(o != NULL);
...
/* $begin(test/targetApi/tc_createAuto) */
    test_intTargetCreate_auto(o, 10, 20);
    test_assert(o != NULL);
    test_assert(corto_checkState(o, CORTO_DEFINED));
    test_assert(o->actual == 10);
    test_assert(o->target == 20);
...
/* $begin(test/targetApi/tc_createChild) */
    test_intTarget o = test_intTargetCreateChild(root_o, "o", 10, 20);
    test_assert(o != NULL);
    test_assert(corto_checkState(o, CORTO_DEFINED));
...
/* $begin(test/targetApi/tc_createChildAuto) */
    test_intTargetCreateChild_auto(root_o, o, 10, 20);
    test_assert(o != NULL);
    test_assert(corto_checkState(o, CORTO_DEFINED));
    test_assert(corto_checkAttr(o, CORTO_ATTR_SCOPED));
    test_assert(corto_parentof(o) == root_o);
...
/* $begin(test/targetApi/tc_fromStr) */
    ...
    corto_setOwner(m);
    test_intTargetFromStr(o, "{40,50}");
    test_assert(o->actual == 30); /* object is not owned by this thread */
    test_assert(o->target == 50);
