...
/* $begin(test/OptionalApi/tc_update) */
    ...
    result = corto_listen(this, test_OptionalApi_onUpdate_o, CORTO_ON_UPDATE, o, NULL);
    ...
    result = corto_silence(this, test_OptionalApi_onUpdate_o, CORTO_ON_UPDATE, o);
    test_assert(result == 0);
