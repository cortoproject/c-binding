...
/* $begin(test/OptionalCompositeApi/tc_update) */
    ...
    result = corto_listen(this, test_OptionalCompositeApi_onUpdate_o, CORTO_ON_UPDATE, o, NULL);
    ...
    result = corto_silence(this, test_OptionalCompositeApi_onUpdate_o, CORTO_ON_UPDATE, o);
    test_assert(result == 0);
