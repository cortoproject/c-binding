...
/* $begin(test/OptionalStringApi/tc_update) */
    ...
    result = corto_listen(_this, test_OptionalStringApi_onUpdate_o, CORTO_ON_UPDATE, o, NULL);
    ...
    result = corto_silence(_this, test_OptionalStringApi_onUpdate_o, CORTO_ON_UPDATE, o);
    test_assert(result == 0);
