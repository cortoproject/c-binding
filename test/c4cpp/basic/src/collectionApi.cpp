...
/* $begin(test/collectionApi/tc_update) */
    ...
    result = corto_listen(_this, test_collectionApi_onUpdate_o, CORTO_ON_UPDATE, o, NULL);
    test_assert(result == 0);
    ...
    result = corto_silence(_this, test_collectionApi_onUpdate_o, CORTO_ON_UPDATE, o);
    test_assert(result == 0);
